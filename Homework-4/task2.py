...
def reversing_string(string):                               # функция реверса любой строки
    return string[::-1]


list_of_strings = ["apple", "banana", "cherry"]
map_of_rev_strings = map(reversing_string, list_of_strings)  # реверс всех строк списка и запись их в мап-список строк
